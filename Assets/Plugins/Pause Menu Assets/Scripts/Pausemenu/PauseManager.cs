...
namespace GreatArcStudios
{
    ...
    public class PauseManager : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            {
                Debug.LogError("Settings file not found. Please make sure you have a settings file in the persistent data path. " + e.Message);
            }
            try
            {
        ...
        public void Update()
        {
            ...
            if (Keyboard.current.escapeKey.wasPressedThisFrame && mainPanel.active == false)
            {
            ...
            else if(Keyboard.current.escapeKey.wasPressedThisFrame && mainPanel.active == true) {
                Time.timeScale = timeScale;
                mainPanel.SetActive(false);
                vidPanel.SetActive(false);
                audioPanel.SetActive(false);
